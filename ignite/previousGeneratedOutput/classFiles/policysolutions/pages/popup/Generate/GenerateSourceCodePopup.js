...
export class GenerateSourceCodePopup {
	...
	changesDetectionAlertCloseBtn = PcfButton('#GenerateSourceCodePopup-changesDetectionAlert-CloseBtn');
	generateSourceCodePopupcurrencyMismatchAlert = PcfButton('#GenerateSourceCodePopup-currencyMismatchAlert');
	currencyMismatchAlertCloseBtn = PcfButton('#GenerateSourceCodePopup-currencyMismatchAlert-CloseBtn');
}
