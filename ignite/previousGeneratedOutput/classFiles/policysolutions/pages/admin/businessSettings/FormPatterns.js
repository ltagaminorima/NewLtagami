...
export class FormPatterns {
	...
	searchLinksInputSetReset = PcfButton('#FormPatterns-FormPatternSearchScreen-FormPatternSearchDV-SearchAndResetInputSet-SearchLinksInputSet-Reset');
	searchLinksInputSetSearch = PcfButton('#FormPatterns-FormPatternSearchScreen-FormPatternSearchDV-SearchAndResetInputSet-SearchLinksInputSet-Search');
