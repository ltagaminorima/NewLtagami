...
export class NewSubmission {
	newSubmissionScreenAcordProductCode = PcfSelectInput('#NewSubmission-NewSubmissionScreen-AcordProductCode');
	newSubmissionScreenAcordProductLabel = PcfTextInput('#NewSubmission-NewSubmissionScreen-AcordProductLabel');
